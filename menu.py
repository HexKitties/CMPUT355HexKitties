...
class Menu():
	...
	def __init__(self, screen, bgr_color):
		...
		self.boardsize_button = pygame.Rect(self.size[0] * 1 / 2 - 150/2, self.size[1] * 2 / 7, 150, 50)
		self.levels_button = pygame.Rect(self.size[0] * 1 / 2 - 150/2, self.size[1] * 3 / 7, 150, 50)
		self.start_button = pygame.Rect(self.size[0] * 1 / 2 - 150/2, self.size[1] * 4 / 7, 150, 50)
	...
	def draw_level(self, mouse_pos):
		level = "easy" if globvar.hex_brd.level == 0 else "hard"
